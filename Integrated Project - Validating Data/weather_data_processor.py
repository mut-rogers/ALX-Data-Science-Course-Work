...
This module is used to process the weather data 
...
class WeatherDataProcessor:
    ...
    def initialize_logging(self, logging_level):
        """Sets up the logging level for this instance"""
    ...
    def weather_station_mapping(self):
        """Fetches weather station data (CSV) from the Web URL"""
    ...
    def extract_measurement(self, message):
        """Extracts the measurement types from the sensor messages"""
